...
$animal = [
    ...
    'racas' => [
        ...
        ['emoji'=>'🐖','nome'=>'Landrace',    'tipo'=>'Corte', 'imagem'=>'https://images.unsplash.com/photo-1537033206914-9d3551ff8103?w=600&q=80&auto=format&fit=crop','desc'=>'Raça escandinava com carcaça extra-longa (76–81 cm) e orelhas grandes totalmente caídas para a frente — distinção visual principal. Base do presunto e lombo industriais. Conversão 2,3–2,6:1, abate com 95–115 kg. Altamente sensível ao calor (zona de conforto: 16–22°C) — exige sombra, aspersão e ventilação cruzada obrigatórias no Maranhão.'],
        ['emoji'=>'🐗','nome'=>'Piau',        'tipo'=>'Misto', 'imagem'=>'https://images.unsplash.com/photo-1567463087469-192a295e77fd?w=600&q=80&auto=format&fit=crop','desc'=>'Raça nacional de origem ibérica (nome tupi: "malhado"), pelagem creme com manchas pretas irregulares. Ganho diário de 469 g e carcaça resfriada de 71 kg (Embrapa). Alta rusticidade ao calor e à alimentação alternativa (resíduos de mandioca, milho, farelo de coco). Risco de extinção — menos de 1.000 animais puros registrados no PBB. Ideal para sistemas extensivos do Nordeste.'],
    ],
    'topicos' => [
        [
            'titulo' => 'Ambiência',
